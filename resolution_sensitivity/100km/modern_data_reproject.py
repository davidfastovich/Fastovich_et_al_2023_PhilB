...
OUTPUT:
    * RESOLUTION_SENSITIVITY/100KM/MODERN_DATA/POSTPROCESSED/GLDAS_100KM_ALBERS.NC
    * RESOLUTION_SENSITIVITY/100KM/MODERN_DATA/POSTPROCESSED/WC_PR_ANNUAL_100KM_ENA.TIF
    * RESOLUTION_SENSITIVITY/100KM/MODERN_DATA/POSTPROCESSED/WC_TAVE_ANNUAL_100KM_ENA.TIF
...
ena_regridded_mask = ena_regridded_mask.rename({'x':'lon',
                                                  'y':'lat'})
# Save as netCDF4
ena_regridded_mask.to_netcdf(('resolution_sensitivity/100km/modern_data/postprocessed/GLDAS_100km_albers.nc'))
...
# Save as geoTIFF
ena_regridded_wc_tave_annual.rio.to_raster(('resolution_sensitivity/100km/modern_data/postprocessed/wc_tave_annual_100km_ena.tif'))
...
# Save as geoTIFF
ena_regridded_wc_pr_annual.rio.to_raster(('resolution_sensitivity/100km/modern_data/postprocessed/wc_pr_annual_100km_ena.tif'))
