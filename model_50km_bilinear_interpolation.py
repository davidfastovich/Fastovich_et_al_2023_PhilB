...
# Write CRS to target_array xarray instance
...
for file in glob.glob('model_temperature_anomaly/*.nc'):
    ...
    # Save as netCDF4
    ena_regridded_model.to_netcdf(('model_temperature_anomaly_50km_ena/' 
                                   + file[26:len(file)-3] 
                                   + '_50km_ena.nc'))
...
for file in glob.glob('model_precipitation_anomaly/*.nc'):
    ...
    # Save as netCDF4
    ena_regridded_model.to_netcdf(('model_precipitation_anomaly_50km_ena/' 
                                   + file[28:len(file)-3] 
                                   + '_50km_ena.nc'))
